...
-- =============================================================================
-- PHASE 4: STOCK INVENTORY (lot_id, product_id, stock_quantity, reserved_quantity, import_price, manufacture_date, expiration_date, status, version)
...
INSERT INTO stock_inventories (
    lot_id, product_id, stock_quantity, reserved_quantity, import_price, 
    manufacture_date, expiration_date, status, version
) VALUES
-- Electronics (no expiry)
('lot-001', 'prod-001', 150, 0, 120000, '2025-11-01', NULL, 'AVAILABLE', 0),
('lot-002', 'prod-002', 300, 0, 28000, '2025-11-05', NULL, 'AVAILABLE', 0),
('lot-003', 'prod-003', 200, 0, 68000, '2025-11-03', NULL, 'AVAILABLE', 0),
('lot-004', 'prod-004', 100, 0, 75000, '2025-10-01', NULL, 'AVAILABLE', 0),

-- Groceries & Food (with future expiry)
('lot-005', 'prod-005', 400, 0, 22000, '2025-11-10', '2027-11-10', 'AVAILABLE', 0),
('lot-006', 'prod-006', 250, 0, 38000, '2025-09-15', '2027-09-15', 'AVAILABLE', 0),
('lot-007', 'prod-007', 600, 0, 18000, '2025-12-08', '2026-06-08', 'AVAILABLE', 0),
('lot-008', 'prod-008', 180, 0, 26000, '2025-08-20', '2028-08-20', 'AVAILABLE', 0),

-- Beverages (with future expiry)
('lot-009', 'prod-009', 1000, 0, 9500, '2025-11-12', '2026-11-12', 'AVAILABLE', 0),
('lot-010', 'prod-010', 2000, 0, 4500, '2025-12-15', '2026-12-15', 'AVAILABLE', 0),
('lot-011', 'prod-011', 300, 0, 28000, '2025-11-10', '2026-05-10', 'AVAILABLE', 0),
('lot-012', 'prod-012', 250, 0, 48000, '2025-10-01', '2027-10-01', 'AVAILABLE', 0),

-- Dairy Products (short expiry - for testing expiring-soon)
('lot-013', 'prod-013', 200, 0, 26000, '2026-01-17', '2026-01-25', 'AVAILABLE', 0),
('lot-014', 'prod-014', 180, 0, 22000, '2026-01-16', '2026-01-28', 'AVAILABLE', 0),
('lot-015', 'prod-015', 100, 0, 55000, '2025-12-10', '2026-06-10', 'AVAILABLE', 0),

-- Personal Care (long expiry)
('lot-016', 'prod-016', 120, 0, 62000, '2025-10-01', '2028-10-01', 'AVAILABLE', 0),
('lot-017', 'prod-017', 350, 0, 18000, '2025-09-15', '2028-09-15', 'AVAILABLE', 0),
('lot-018', 'prod-018', 280, 0, 33000, '2025-11-05', '2028-11-05', 'AVAILABLE', 0),
('lot-019', 'prod-019', 200, 0, 28000, '2025-11-08', '2029-11-08', 'AVAILABLE', 0),

-- Snacks & Candy (medium expiry)
('lot-020', 'prod-020', 400, 0, 14000, '2025-12-10', '2026-06-10', 'AVAILABLE', 0),
('lot-021', 'prod-021', 500, 0, 11000, '2025-10-15', '2026-10-15', 'AVAILABLE', 0),
('lot-022', 'prod-022', 300, 0, 25000, '2025-11-05', '2026-08-05', 'AVAILABLE', 0),

-- Cleaning Supplies (long expiry)
('lot-023', 'prod-023', 150, 0, 28000, '2025-09-01', '2028-09-01', 'AVAILABLE', 0),
('lot-024', 'prod-024', 200, 0, 42000, '2025-10-10', '2028-10-10', 'AVAILABLE', 0),
('lot-025', 'prod-025', 180, 0, 22000, '2025-11-01', NULL, 'AVAILABLE', 0),

-- Stationery (no expiry)
('lot-026', 'prod-026', 250, 0, 19000, '2025-10-01', NULL, 'AVAILABLE', 0),
('lot-027', 'prod-027', 100, 0, 72000, '2025-09-20', NULL, 'AVAILABLE', 0),
('lot-028', 'prod-028', 200, 0, 25000, '2025-11-05', NULL, 'AVAILABLE', 0),

-- Home & Kitchen (no expiry)
('lot-029', 'prod-029', 80, 0, 36000, '2025-10-15', NULL, 'AVAILABLE', 0),
('lot-030', 'prod-030', 150, 0, 30000, '2025-11-01', NULL, 'AVAILABLE', 0)
...
('promo-001', 'Flash Sale Điện Tử', 'Giảm giá sốc các sản phẩm điện tử trong 3 ngày', 'PERCENTAGE', 15, NULL, NULL, CURRENT_DATE - INTERVAL '2 days', CURRENT_DATE + INTERVAL '1 day', 'ACTIVE', true),
('promo-002', 'Mua 2 Tặng 1', 'Áp dụng cho tất cả đồ ăn vặt', 'BUY_X_GET_Y', 33, 2, 1, CURRENT_DATE - INTERVAL '5 days', CURRENT_DATE + INTERVAL '16 days', 'ACTIVE', true),
('promo-003', 'Khuyến Mãi Hàng Tươi Sống', 'Giảm 10% cho sữa tươi, trứng, rau đông lạnh', 'PERCENTAGE', 10, NULL, NULL, CURRENT_DATE - INTERVAL '5 days', CURRENT_DATE + INTERVAL '11 days', 'ACTIVE', true)
